...
const Sidebar = () => {
  ...
  const filteredUsers = input
    ? users.filter((user) =>
        user.fullName.toLoverCase().includes(input.toLowerCase())
      )
    : users;
  ...
  return (
    <div
      className={`bg-[#5158B2]/10 h-full p-5 rounded-r-xl overflow-y-scroll text-white ${
